            ...
            <div class="col-12 col-lg-10 col-xl-9">
                ...
                <div>
                    @if(Session::has("cart"))
                        ...
                        <p class="mt-6">CONTACT INFORMATION:</p>
                        ...
                        <div class="form-group">
                            {{Form::text("name_shipping", "", ["class" => "form-control", "placeholder" => "Name", "required" => true])}}
                        </div>
                
                        <div class="form-group">
                            {{Form::text("surname_shipping", "", ["class" => "form-control", "placeholder" => "Surname", "required" => true])}}
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-8">
                                <select id="country" name="country" class="col-12">
                            ...
                            <div class="form-group col-12 col-sm-4">
                                {{Form::text("postal_code", "", ["class" => "form-control", "placeholder" => "Postal code", "required" => true])}}
                            </div>
                        </div>
                        ...
                        <div class="row mt-4 mb-5">
                            <div class="col-12 text-right">
                                <button class="artshop-button">Continue</button>
                            </div>
                        </div>
